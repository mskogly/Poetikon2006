                  ...
                  Set MyTextFile=MyFileObject.OpenTextFile("d:\sites\www.katode.org\poetikon\asp\caro_te.txt", 8, TRUE)
...
<%
                  Set MyFileObject=Server.CreateObject("Scripting.FileSystemObject")
                  Set MyTextFile=MyFileObject.OpenTextFile("d:\sites\www.katode.org\poetikon\asp\caro_te.txt")
...
<p>
Gå til http://poetikon.org for å slarve om te. - <p>
