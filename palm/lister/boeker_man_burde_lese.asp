                  ...
                  Set MyTextFile=MyFileObject.OpenTextFile("d:\sites\www.katode.org\poetikon\asp\boeker_man_burde_lese.txt", 8, TRUE)
...
<b>Bøker man burde lese</b>

<ol>
<%
                  Set MyFileObject=Server.CreateObject("Scripting.FileSystemObject")
                  Set MyTextFile=MyFileObject.OpenTextFile("d:\sites\www.katode.org\poetikon\asp\boeker_man_burde_lese.txt")
