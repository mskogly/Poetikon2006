...
d_on=new Image();
d_off.src="m_off.gif";
d_on.src="m_selected.gif";

e_off=new Image();
e_on=new Image();
e_off.src="m_off.gif";
e_on.src="m_selected.gif";

f_off=new Image();
f_on=new Image();
f_off.src="m_off.gif";
f_on.src="m_selected.gif";

g_off=new Image();
g_on=new Image();
g_off.src="m_off.gif";
g_on.src="m_selected.gif";

h_off=new Image();
h_on=new Image();
h_off.src="m_off.gif";
h_on.src="m_selected.gif";

i_off=new Image();
i_on=new Image();
i_off.src="m_off.gif";
i_on.src="m_selected.gif";
